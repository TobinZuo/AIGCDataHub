.PHONY: validate freshness discovery discovery-accept readme readme-check dataset-access-index dataset-access-index-check model-data-index model-data-index-check site-data site-data-check test check-links audit-example audit-example-check check
...
check: validate freshness readme-check dataset-access-index-check model-data-index-check site-data-check audit-example-check test
