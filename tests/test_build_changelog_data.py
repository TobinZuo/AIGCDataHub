...
class BuildChangelogDataTests(unittest.TestCase):
    def test_builds_newest_first_structured_history(self):
        ...
        latest = entries[0]
        self.assertEqual(latest["date"], "2026-08-05")
        ...
        self.assertIn("Qwen Image 3.0 Pro", latest["summary"][0]["text"]["zh"])
        self.assertIn("Qwen Image 3.0 Pro", latest["summary"][0]["text"]["en"])
        self.assertEqual(
            latest["summary"][0]["links"][0],
            {
                "href": "/#model-qwen-image-3-0-pro",
                "label": {"zh": "Qwen Image 3.0 Pro", "en": "Qwen Image 3.0 Pro"},
            },
        )
