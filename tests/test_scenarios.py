...
class ScenarioTaxonomyTests(unittest.TestCase):
    ...
    def test_scenario_lineage_for_requested_application_models(self) -> None:
        ...
        self.assertIn("video-localization", models["voicecraft-dub"]["scenario_ids"])
        self.assertIn("video-localization", models["holidubber"]["scenario_ids"])
        self.assertIn("video-localization", datasets["lrs3"]["scenario_ids"])
        self.assertIn("video-localization", datasets["voxceleb2"]["scenario_ids"])
        self.assertIn("video-localization", datasets["celebv-dub"]["scenario_ids"])
        self.assertIn("video-localization", datasets["holidub-bench"]["scenario_ids"])
