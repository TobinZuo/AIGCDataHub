...
| [CoinVE-Edit](models/video/coinve-edit.yaml) | Tencent Smart Creation Platform | video, image | 2026-08-13 | open weights | partial | [GPT-Image-Edit-1.5M](catalog/image/gpt-image-edit-1-5m.yaml), [NHR-Edit](catalog/image/nhr-edit.yaml), [Pico-Banana-400K](catalog/image/pico-banana-400k.yaml), [OpenVE-3M](catalog/video/openve-3m.yaml), [Ditto-1M](catalog/video/ditto-1m.yaml), [ReCo-Data](catalog/video/reco-data.yaml), [CoinVE-200K](catalog/video/coinve-200k.yaml), [CoinVE-Bench](catalog/evaluation/coinve-bench.yaml) | 🟡 |
| [CMD](models/video/cmd.yaml) | NVIDIA | video, image, 3d | 2026-08-13 | open weights | partial | [DL3DV-10K](catalog/video/dl3dv-10k.yaml), Unnamed generated and curated video corpus, [VBench-I2V](catalog/evaluation/vbench-i2v.yaml), [SANA-WM-Bench](catalog/evaluation/sana-wm-bench.yaml) | 🟡 |
...
| [Wan 2.7](models/video/wan-2-7.yaml) | Alibaba Cloud | video, audio | 2026-04-03 | api only | undisclosed | [OmniEdit-Bench](catalog/evaluation/omniedit-bench.yaml) | 👀 |
...
| [Seedance 2.0](models/video/seedance-2-0.yaml) | ByteDance Seed | video, audio | 2026-02-12 | api only | undisclosed | [AVGen-Bench](catalog/evaluation/avgen-bench.yaml), [OmniEdit-Bench](catalog/evaluation/omniedit-bench.yaml) | 👀 |
...
| [Kling AI 3.0](models/video/kling-3.yaml) | Kuaishou Technology | video, audio, image | 2026-02-05 | product only | undisclosed | [OmniEdit-Bench](catalog/evaluation/omniedit-bench.yaml) | 👀 |
...
| [Grok Imagine Video](models/video/grok-imagine-video.yaml) | xAI | video, audio | 2026-01-28 | api only | undisclosed | [OmniEdit-Bench](catalog/evaluation/omniedit-bench.yaml) | 👀 |
...
| [Seedream 4.0](models/image/seedream-4-0.yaml) | ByteDance Seed | image | 2025-09-09 | api only | partial | Seedream 4.0 multimodal pretraining mixture, Seedream 4.0 editing triples, Seedream 4.0 human preference data, [MagicBench 4.0](catalog/evaluation/magicbench-4-0.yaml), [DreamEval](catalog/evaluation/dreameval.yaml) | 🟡 |
...
| [Runway Aleph](models/video/runway-aleph.yaml) | Runway | video | 2025-07-25 | product only | undisclosed | [OmniEdit-Bench](catalog/evaluation/omniedit-bench.yaml) | 👀 |
...
| [CoinVE-Bench](catalog/evaluation/coinve-bench.yaml) | Tencent Smart Creation Platform | evaluation | 2026-08-13 | video editing, compositional video editing | 361 | [download / browse (open)](https://huggingface.co/datasets/FireCRT/CoinVE-Bench) | review required | 🟡 |
| [CoinVE-200K](catalog/video/coinve-200k.yaml) | Tencent Smart Creation Platform | video | 2026-08-13 | video editing, compositional video editing | ~200K | [download / browse (open)](https://huggingface.co/datasets/FireCRT/CoinVE-200K) | noncommercial | 🟡 |
...
| [OpenHumanVid-Talking](catalog/video/openhumanvid-talking.yaml) | Haoson Zhang | video | 2026-07-15 | audio driven avatar, talking head generation, text to video | ~9K | [download / browse (open)](https://huggingface.co/datasets/Haosonnn/OpenHumanVid-Talking) | noncommercial | ✅ |
...
| [OmniEdit-Bench](catalog/evaluation/omniedit-bench.yaml) | The University of Hong Kong, Alibaba Wan Team, Zhejiang University, and Peking University | evaluation | 2026-05-07 | video editing, reference based video editing, audio editing | 790 | [download / browse (open)](https://huggingface.co/datasets/OmniEdit-Bench/OmniEdit-Bench) | noncommercial | 🟡 |
...
| [PanShot](catalog/video/panshot.yaml) | Monash University and collaborators | video | 2026-02-04 | text to video, camera controlled video generation, camera pose estimation | unknown | [download / browse (open)](https://huggingface.co/datasets/chengzhag/PanShot) | review required | 🟡 |
...
| [ReCo-Data](catalog/video/reco-data.yaml) | HiDream.ai | video | 2025-12-12 | video editing, instruction guided video editing | ~524.4K | [download / browse (open)](https://huggingface.co/datasets/HiDream-ai/ReCo-Data) | noncommercial | 🟡 |
...
| [Pico-Banana-400K](catalog/image/pico-banana-400k.yaml) | Apple | image | 2025-10-22 | image editing, instruction guided image editing, multi turn image editing, preference learning | ~400K | [URLs / downloader (open)](https://github.com/apple/pico-banana-400k) | noncommercial | 🟡 |
...
| [MagicBench 4.0](catalog/evaluation/magicbench-4-0.yaml) | ByteDance Seed | evaluation | 2025-09-24 | text to image, image editing, multi image editing | 725 | [availability notice (unavailable)](https://arxiv.org/abs/2509.20427) | unknown | 🟡 |
| [DreamEval](catalog/evaluation/dreameval.yaml) | ByteDance Seed | evaluation | 2025-09-24 | text to image, image generation evaluation | 1.6K | [availability notice (unavailable)](https://arxiv.org/abs/2509.20427) | unknown | 🟡 |
...
| [OmniWorld](catalog/video/omniworld.yaml) | Shanghai AI Laboratory and collaborators | video | 2025-09-16 | camera controlled video generation, 4d world modeling, future frame prediction, 3d reconstruction | ~600K | [download / browse (open)](https://huggingface.co/datasets/InternRobotics/OmniWorld) | noncommercial | 🟡 |
...
| [SAT-493M](catalog/image/sat-493m.yaml) | Meta and collaborators | image | 2025-08-14 | self supervised pretraining, satellite image representation learning | ~493M | [availability notice (unavailable)](https://github.com/facebookresearch/dinov3) | unknown | 🟡 |
...
| [GPT-Image-Edit-1.5M](catalog/image/gpt-image-edit-1-5m.yaml) | UCSC VLAA | image | 2025-07-28 | image editing, instruction guided image editing | ~1.5M | [download / browse (open)](https://huggingface.co/datasets/UCSC-VLAA/GPT-Image-Edit-1.5M) | review required | 🟡 |
| [NHR-Edit](catalog/image/nhr-edit.yaml) | NHR authors | image | 2025-07-17 | image editing, instruction guided image editing | ~720K | [download / browse (open)](https://huggingface.co/datasets/iitolstykh/NHR-Edit) | review required | 🟡 |
...
| [PosterCraft public training corpora](catalog/image/postercraft-public-corpora.yaml) | PosterCraft team | image | 2025-06-12 | text to image, poster generation, text rendering | ~2.2M | [download / browse (gated)](https://huggingface.co/PosterCraft/datasets) | noncommercial | 🟡 |
...
| [MVHumanNet++](catalog/3d/mvhumannet-plus-plus.yaml) | GAP-Lab, CUHK-Shenzhen | 3d | 2025-05-03 | digital human, 3d avatar generation, human digitization, multi view human reconstruction | ~645M | [request access (gated)](https://www.modelscope.cn/datasets/GAP-Lab/MVHumanNet_plusplus) | noncommercial | 🟡 |
...
| [Git-10M](catalog/image/git-10m.yaml) | Beihang University and collaborators | image | 2025-01-02 | text to image, remote sensing image generation, vision language pretraining | ~10.5M | [download / browse (open)](https://huggingface.co/datasets/lcybuaa/Git-10M) | noncommercial | 🟡 |
...
| [VBench-I2V](catalog/evaluation/vbench-i2v.yaml) | Vchitect | evaluation | 2024-03-01 | image to video, video generation evaluation | unknown | [download / browse (open)](https://github.com/Vchitect/VBench) | review required | 🟡 |
...
| [SkyScript](catalog/image/skyscript.yaml) | University of Wisconsin-Madison and collaborators | image | 2023-12-20 | vision language pretraining, remote sensing retrieval | ~5.2M | [download / browse (open)](https://github.com/wangzhecheng/SkyScript) | review required | 🟡 |
...
| [GeoPile](catalog/image/geopile.yaml) | University of North Carolina at Charlotte and collaborators | image | 2023-02-09 | image pretraining, remote sensing representation learning | ~600K | [availability notice (unavailable)](https://arxiv.org/abs/2302.04476) | review required | 🟡 |
...
| [SSL4EO-S12](catalog/image/ssl4eo-s12.yaml) | Technical University of Munich and collaborators | image | 2022-11-14 | self supervised pretraining, earth observation | 3M | [download / browse (open)](https://mediatum.ub.tum.de/1650201) | allowed | ✅ |
...
| [Million-AID](catalog/image/million-aid.yaml) | Wuhan University | image | 2020-06-22 | remote sensing scene classification, image pretraining | 1M | [download / browse (open)](https://captain-whu.github.io/DiRS/) | noncommercial | 🟡 |
...
| [DIOR](catalog/image/dior.yaml) | Northwestern Polytechnical University | image | 2019-04-08 | remote sensing object detection, image pretraining | 23.5K | [download / browse (open)](https://gcheng-nwpu.github.io/) | noncommercial | 🟡 |
...
| [RealEstate10K](catalog/video/realestate10k.yaml) | Google | video | 2018-07-01 | novel view synthesis, camera controlled video generation, 3d reconstruction | ~80K | [URLs / downloader (open)](https://google.github.io/realestate10k/download.html) | review required | ✅ |
...
| [RSI-CB](catalog/image/rsicb.yaml) | Central South University and collaborators | image | 2017-05-30 | remote sensing scene classification, image pretraining | 36.7K | [download / browse (open)](https://github.com/lehaifeng/RSI-CB) | noncommercial | 🟡 |
